...
{
    [MAPSEC_EVERBREEZE_TOWN] = {MAP_GROUP(EVERBREEZE_TOWN), MAP_NUM(EVERBREEZE_TOWN), HEAL_LOCATION_LITTLEROOT_TOWN_BRENDANS_HOUSE_2F},
...
static void CreateFlyDestIcons(void)
{
    ...
    for (mapSecId = MAPSEC_EVERBREEZE_TOWN; mapSecId <= MAPSEC_EVER_GRANDE_CITY; mapSecId++)
    {
