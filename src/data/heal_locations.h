static const struct HealLocation sHealLocations[] =
{
    ...
    [HEAL_LOCATION_LITTLEROOT_TOWN_BRENDANS_HOUSE - 1] = {MAP_GROUP(EVERBREEZE_TOWN), MAP_NUM(EVERBREEZE_TOWN), 13, 11},
    [HEAL_LOCATION_LITTLEROOT_TOWN_MAYS_HOUSE - 1] = {MAP_GROUP(EVERBREEZE_TOWN), MAP_NUM(EVERBREEZE_TOWN), 32, 9},
