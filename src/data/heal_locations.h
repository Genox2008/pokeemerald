...
{
    [HEAL_LOCATION_LITTLEROOT_TOWN_BRENDANS_HOUSE_2F - 1] = {MAP_GROUP(LITTLEROOT_TOWN_BRENDANS_HOUSE_2F), MAP_NUM(LITTLEROOT_TOWN_BRENDANS_HOUSE_2F), 5, 4},
    ...
    [HEAL_LOCATION_LITTLEROOT_TOWN_BRENDANS_HOUSE - 1] = {MAP_GROUP(LITTLEROOT_TOWN), MAP_NUM(LITTLEROOT_TOWN), 12, 13},
    [HEAL_LOCATION_LITTLEROOT_TOWN_MAYS_HOUSE - 1] = {MAP_GROUP(LITTLEROOT_TOWN), MAP_NUM(LITTLEROOT_TOWN), 31, 11},
    [HEAL_LOCATION_OLDALE_TOWN - 1] = {MAP_GROUP(OLDALE_TOWN), MAP_NUM(OLDALE_TOWN), 12, 7},
    ...
    [HEAL_LOCATION_MAGMARIDGE_TOWN - 1] = {MAP_GROUP(MAGMARIDGE_TOWN), MAP_NUM(MAGMARIDGE_TOWN), 12, 5},
    [HEAL_LOCATION_OTUS_TOWN - 1] = {MAP_GROUP(OTUS_TOWN), MAP_NUM(OTUS_TOWN), 12, 13},
};
