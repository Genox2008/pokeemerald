...
const u32 gPMPItemIcon_MagmaStone[] = INCBIN_U32("graphics/items/icons/magma_stone.4bpp.lz");
const u32 gPMPItemIconPalette_MagmaStone[] = INCBIN_U32("graphics/items/icon_palettes/magma_stone.gbapal.lz");